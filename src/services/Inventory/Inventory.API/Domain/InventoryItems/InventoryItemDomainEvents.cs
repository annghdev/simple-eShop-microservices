...
public record ReservationSucceeded(Guid Id, int Quantity, Guid OrderId) : IDomainEvent, IReservationEvent;
public record ReservationFailed(Guid Id, int Quantity, Guid OrderId) : IDomainEvent, IReservationEvent;
public record ReservationCommitted(Guid Id, int Quantity, Guid OrderId) : IDomainEvent, IReservationEvent;
public record ReservationReleased(Guid Id, int Quantity, Guid OrderId) : IDomainEvent, IReservationEvent;
public record ReservationRestocked(Guid Id, int Quantity, Guid OrderId) : IDomainEvent, IReservationEvent;
